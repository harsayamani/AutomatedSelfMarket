...
<head>
    ...
    <title> @yield('title') | Admin ASM</title>
    @include('/admin/style/styleAdmin')
...
<body>
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <img src="/admin/assets/images/logo_asm2.png" style="width:140px; height:40px" alt="homepage" class="light-logo" />
    ...
    <!-- ============================================================== -->
    <!-- ============================================================== -->
    @include('/admin/script/scriptAdmin')
